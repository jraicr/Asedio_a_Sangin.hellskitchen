if(isServer) then {
	...
	while {_i < _FilasCompletas} do {
		[[(getPos _rack select 0) - 0.24 + _separacionFilas_x*_i,(getPos _rack select 1) + 0.315 + _separacionFilas_y*_i,(getPos _rack select 2) - 0.285], getDir _rack,vectorDir _rack,_separacion_armas,_classname_Weapon,4] spawn _crearFila;
		[[(getPos _rack select 0) - 0.24 + _separacionFilas_x*_i + _separacion_x*5,(getPos _rack select 1) + 0.315 + _separacionFilas_y + _separacion_y*5,(getPos _rack select 2) - 0.285], getDir _rack,vectorDir _rack,_separacion_armas,_classname_Weapon,4] spawn _crearFila;
		_i = _i + 1;
	};
	
	if (_mediasFilasCompletas == 1) then {
		[[(getPos _rack select 0) - 0.24 + _separacionFilas_x*_i,(getPos _rack select 1) + 0.315 + _separacionFilas_y*_i,(getPos _rack select 2) - 0.285], getDir _rack,vectorDir _rack,_separacion_armas,_classname_Weapon,4] spawn _crearFila;
		[[(getPos _rack select 0) - 0.24 + _separacionFilas_x*_i + _separacion_x*5,(getPos _rack select 1) + 0.315 + _separacionFilas_y + _separacion_y*5,(getPos _rack select 2) - 0.285], getDir _rack,vectorDir _rack,_separacion_armas,_classname_Weapon,_armasSueltas] spawn _crearFila;
	} else {
		[[(getPos _rack select 0) - 0.24 + _separacionFilas_x*_i,(getPos _rack select 1) + 0.315 + _separacionFilas_y,(getPos _rack select 2) - 0.285], getDir _rack,vectorDir _rack,_separacion_armas,_classname_Weapon,_armasSueltas] spawn _crearFila;
	};
